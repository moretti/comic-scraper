...
def test_xkcd_feed():
    ...
    assert_equal(entry.image_content, u"""<img alt="Better change the URL to 'https' before downloading." src="http://imgs.xkcd.com/comics/the_mother_of_all_suspicious_files.png" title="Better change the URL to 'https' before downloading."/>""")
...
def test_doghouse_feed():
    ...
    assert_equal(entry.link, 'http://feedproxy.google.com/~r/thedoghousediaries/feed/~3/rml4PlBNLcs/5275')
    ...
    assert_equal(entry.image_content, u"""<img alt="Amazing Scientific Breakthroughs " src="http://thedoghousediaries.com/comics/uncategorized/2013-08-05-9680a48.png" title="You know what they say, it\u2019s better to have a late mouseover than to have no mouseover at all."/>""")
    assert_is_not_none(entry.published)
    assert_equal(entry.published.timetuple(), (2013, 8, 5, 12, 46, 56, 0, 217, -1))
